---
title: "timmd-9216/mediaparty-trust-api: Diggity: a tool for checking the quality of journalistic content"
source: "https://github.com/timmd-9216/mediaparty-trust-api/tree/main"
author:
published:
created: 2026-04-13
description: "Diggity: a tool for checking the quality of journalistic content - timmd-9216/mediaparty-trust-api"
tags:
  - "raw"
---
...
**Note**: If using `uv`, see [SETUP.md](https://github.com/timmd-9216/mediaparty-trust-api/blob/main/SETUP.md) for known issues on macOS ARM64.
...
See [SETUP.md](https://github.com/timmd-9216/mediaparty-trust-api/blob/main/SETUP.md) for the complete solution. Summary: use `pip` instead of `uv`.

### Error: OPENROUTER\_API\_KEY not set
...
- **Report Issues**: Found a bug or have a feature idea? [Open an issue](https://github.com/timmd-9216/mediaparty-trust-api/issues)
...
[LICENSE](https://github.com/timmd-9216/mediaparty-trust-api/blob/main/LICENSE)