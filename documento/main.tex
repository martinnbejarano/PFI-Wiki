...
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.43\textwidth}{\raggedright\MakeUppercase{Detección automática de desinformación en redes sociales}}} % El parámetro 0.43 puede modificarse para tener más espacio en la columan del medio, y que así el título de la tesis entre mejor.
			{
				\raisebox{1.5ex}{%
...
\setmarginsrb{2.7cm}{0.5cm}{2.3cm}{1.5cm}{2cm}{1.5cm}{0cm}{1cm}
