...
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.40\textwidth}{\raggedright\MakeUppercase{Sistema de detección automática de desinformación en redes sociales}}} % El parámetro 0.40 puede modificarse para tener más espacio en la columan del medio, y que así el título de la tesis entre mejor.
			{
				\raisebox{1.5ex}{%
