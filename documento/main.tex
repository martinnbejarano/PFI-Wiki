...
\usepackage[backend=biber, style=iso-authoryear, language=spanish,
...
% Para el diagrama de Gantt del cronograma (anexo)
\usepackage{pgfgantt}

% Para la página apaisada del cronograma (anexo)
\usepackage{pdflscape}

% Para diagramas (pipeline de detección en el marco teórico)
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning}

% Para la curva de valor del analisis competitivo
\usepackage{pgfplots}
\pgfplotsset{compat=1.18}

% Colores de la matriz ERIC (capitulo 3)
\definecolor{eliminarBg}{HTML}{FBE4E8}
\definecolor{eliminarFg}{HTML}{C2456B}
\definecolor{reducirBg}{HTML}{FDF3DC}
\definecolor{reducirFg}{HTML}{C08A1E}
\definecolor{incrementarBg}{HTML}{EAE4F7}
\definecolor{incrementarFg}{HTML}{6B4FA8}
\definecolor{crearBg}{HTML}{E2F2E6}
\definecolor{crearFg}{HTML}{3D8B54}

% Gráficos de la encuesta de user research (chapters/figures/encuesta-*.tex)
\definecolor{encuestaBar}{HTML}{3E6FB0}
\definecolor{encuestaBarAlt}{HTML}{C08A1E}

% \parbox[b] es para poner texto sobre el bottom
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.46\textwidth}{\raggedright\footnotesize\MakeUppercase{Sistema de detección automática de desinformación en redes sociales}}} % El parámetro 0.40 puede modificarse para tener más espacio en la columan del medio, y que así el título de la tesis entre mejor.
			{
				\raisebox{1.5ex}{%
					\parbox[b]{0.23\textwidth}{\raggedleft
					\begin{tabular}{r}
						Bejarano Arce, Juan Martín
					\end{tabular}
					}
				}
			}\headrule{}
...
\setmarginsrb{2.7cm}{0.5cm}{2.3cm}{1.5cm}{2cm}{0.5cm}{0cm}{1cm}
...
\newcommand{\Fidel}[1]{\todo[color=green!30,inline]{\textbf{Fidel:} #1}}
\newcommand{\Martin}[1]{\todo[color=blue!20]{\textbf{Martin:} #1}}
...
\includepdf[
  ...
  trim=0 0 0 0,
  clip
]{cover/Caratula 2026.pdf}
\clearpage
	\input{chapters/title}
	% --- Agradecimientos, Resumen y Abstract: se redactan en la entrega final ---
	...
	% --- Capítulos de entregas futuras (Descripción 50%, Conclusión final) ---
